    ...
    <div style={{ minHeight: "100vh", background: "#385780", fontFamily: "-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif", display: "flex", justifyContent: "center", padding: 20 }}>
      <div style={{ width: 380, background: "#0d2c64", borderRadius: 24, padding: 24, color: "#FFFFFF" }}>
        ...
        <div style={{ fontSize: 13, color: "#E4E8F2", lineHeight: 1.6, display: "flex", flexDirection: "column", gap: 14 }}>
          <p><strong>What we collect.</strong> When you use Spot Park, we collect: your email address (for your account), a vehicle profile you provide (year/make/model or body type), photos you upload when listing a space, and location data (only when you choose to use "current location" while listing a space, or when your browser shares your location to center the map).</p>

          <p><strong>How it's used.</strong> This information is used only to operate Spot Park's core features: showing your listings and their location to other users, checking vehicle-to-space fit, and displaying your reservations and reviews to you.</p>
          ...
          <p><strong>Where it's stored.</strong> Data is stored using Supabase, a third-party database provider, and the app itself is hosted on Vercel. Map data is provided by OpenStreetMap.</p>

          <p><strong>Payments.</strong> Spot Park does not currently process real payments. No payment card information is collected at this time.</p>
          ...
          <p><strong>Changes.</strong> This policy may be updated as Spot Park develops. Continued use of the app after changes means you accept the updated policy.</p>
